        ...
        Item {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    // Photo with padding inside card
                    Rectangle {
                        id: photoClip
                        anchors {
                            top: parent.top
            ...
            // Action buttons — YOUR ORIGINAL BUTTONS UNCHANGED
            RowLayout {
                anchors {
                ...
                Button {
                    ...
                    icon.source: "qrc:/assets/home/icons8-retake-100.png"
                ...
                Button {
                    Layout.fillWidth: true; height: 56
                    icon.source: "qrc:/assets/home/icons8-analyse-60.png"
                    icon.width: 25; icon.height: 25; icon.color: "white"
                    text: "Analyse"
                    onClicked: {

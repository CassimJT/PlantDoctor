...
class Jtefield_setterGenerated {
companion object {
	@JvmField val JTE_NAME = "field_setter.kte"
	@JvmField val JTE_LINE_INFO = intArrayOf(15,15,15,16,17,18,19,21,21,21,21,21,22,22,23,24,24,25,25,25,25,25,25,25,25,26,26,26,26,26,26,26,27,27,27,27,31,31,31,21,21,21,21,21)
	@JvmStatic fun render(jteOutput:gg.jte.TemplateOutput, jteHtmlInterceptor:gg.jte.html.HtmlInterceptor?, jteData:JteData) {
		...
		jteOutput.writeContent("void set")
		...
		jteOutput.writeContent("\", ")
		jteOutput.writeUserContent(jteData.fieldSetterParam)
		jteOutput.writeContent(");\r\n    }\r\n\r\n\r\n")
	}
